...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td align="center" valign="center" bgcolor="#333333"
            ...
            <h1 style="color: #ffa941; ">Congratulations, ${email}! </h1>
        </td>
    </tr>
    <tr style="background-color: #c8c8ca; box-shadow: 0px -10px 10px rgba(0, 0, 0, 0.1);">
        <td align="left" valign="center" bgcolor="#c8c8ca"
            ...
            <p style="font-size: 18px; line-height: 1.5; ">
                Dear <span style="font-weight: bold;">${email}</span>,
            </p>
            ...
            <div align="left" style="background-color: rgba(180, 179, 179,0.4); border-left: 4px solid #ffa941; width: 100%; margin-left:20px;">
